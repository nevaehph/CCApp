...
public class BaseActivity extends AppCompatActivity implements WeekView.EventClickListener, MonthLoader.MonthChangeListener, WeekView.EventLongPressListener, WeekView.EmptyViewLongPressListener {
    ...
    public void onEventClick(WeekViewEvent event, RectF eventRect) {
        ...
        float price =0;
        if(event.getName()=="Tennis Court")
            price = 90;
        else if(event.getName()=="Main Hall")
            price = 240;
        else if(event.getName()=="Basketball Court")
            price = 60;
        else if(event.getName()=="Hall 2")
            price = 400;
    ...
    public List<? extends WeekViewEvent> onMonthChange(int newYear, int newMonth) {
        ...
        event = new WeekViewEvent(1,"Tennis Court",
                "Boon Lay Community Centre", startTime, endTime);
        ...
        event = new WeekViewEvent(2,"Main Hall",
                "Lam Soon Community Centre", startTime, endTime);
        ...
        event = new WeekViewEvent(3,"Basketball Court",
                "Clementi Community Centre", startTime, endTime);
        ...
        endTime.set(Calendar.MONTH, newMonth - 1);
        event = new WeekViewEvent(4,"Hall 2",
                "Bishan North Community Centre", startTime, endTime);
        event.setColor(getResources().getColor(R.color.event_color_02));
        events.add(event);
        ...
        endTime.add(Calendar.HOUR, 3);
        endTime.set(Calendar.MONTH, newMonth - 1);
        event = new WeekViewEvent(5,"Tennis Court",
                "Bukit Merah Community Centre", startTime, endTime);
        ...
        endTime.add(Calendar.HOUR, 4);
        endTime.set(Calendar.MONTH, newMonth - 1);
        event = new WeekViewEvent(5,"Mother's Day",
                "Jurong Community Centre", startTime, endTime);
        event.setColor(getResources().getColor(R.color.event_color_01));
        events.add(event);
        ...
        endTime.add(Calendar.HOUR,4);
        endTime.set(Calendar.MONTH, newMonth - 1);
        event = new WeekViewEvent(5,"Racial Harmony Day",
                "Raffles Community Centre", startTime, endTime);
        event.setColor(getResources().getColor(R.color.event_color_01));
        events.add(event);
